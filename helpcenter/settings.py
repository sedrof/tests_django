...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://helpcenter_redis:6379/",
        "OPTIONS": {
            "CLIENT_CLASS": "django_redis.client.DefaultClient",
            "MAX_ENTRIES": 1000,
        },
        "KEY_PREFIX": "helpcenter",
    }
}
...
# Authentication
AUTH_VERIFYING_KEY = get_environment_secret("AUTH_VERIFYING_KEY")
...
#         "debug_toolbar",
#     ]
#     INTERNAL_IPS = ["127.0.0.1", "0.0.0.0", "localhost", "172.26.0.1"]
